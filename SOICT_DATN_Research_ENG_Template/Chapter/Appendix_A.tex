...
\section{SHAP Value Calculation}
\label{app:shap}
...
The raw signed scores are passed directly to the selected normalizer; the implementation
does not take a positive part or absolute value before normalization. These scores are
mapped to a probability vector over non-special prompt tokens via one of four normalizers:
softmax, sparsemax, entmax-1.5, or entmax with
