...
Chapter 2 established the background of the circuit tracing method, 
how the attribution graph is constructed and how it can be used to study the model's internal computation.
Chapter 3 presents the proposed summarization method for
